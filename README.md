...
```javascript
import headerDir from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-shared@v0.1.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/random-base-shared/actions/workflows/test.yml/badge.svg?branch=v0.1.2
[test-url]: https://github.com/stdlib-js/random-base-shared/actions/workflows/test.yml?query=branch:v0.1.2
